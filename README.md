This project is simply iterating through various elements in Dotnet (but does not only apply to Dotnet). Nothing fancy or usable is meant to come from this, just a bit of practice before an interview :P
